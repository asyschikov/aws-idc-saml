...
Usage:
    python generate-config.py   # uses app-outputs.json if present, else fetches from CloudFormation
"""
...
STACK_NAME = "IdcSamlOrgApp"
OUTPUTS_FILE = SCRIPT_DIR / "app-outputs.json"
...
def load_outputs() -> dict:
    """Load outputs from app-outputs.json or fetch from CloudFormation."""
